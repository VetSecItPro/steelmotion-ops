...
|---|---|---|
| Vulnerable patches applied | /sec-ship | confirm fix landed |
| Major version bumps | /test-ship | regression check |
| All clean / patched | /gh-ship | ship the dep updates |
| Breaking changes flagged | /migrate | structured upgrade |
